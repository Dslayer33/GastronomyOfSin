    ...
    return(
        <div className='header-main-block'>
             ...
             <nav className='header-main-block__nav'>
                 <a id='shop_id' href className='header-nav-link'>Shop</a>
                 <a id='contact_id' href className='header-nav-link'>Contact</a>
                 <a id='sign_id' href className='header-nav-link'>Sign In</a>
