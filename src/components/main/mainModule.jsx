...
function Main() {
   ...
   return(
       <div className="main-container">
            <div id='block1' className='main-container__block'>
            ...
            <div id='block2' className='main-container__block'>
                 <div className='block-content'>
                      <div className='content-area'>
            ...
            <div id='block3' className='main-container__block'>
                 <div className='block-content'>
                      <div className='content-area'>
            ...
            <div id='block4' className='main-container__block'>
                  <div className='block-content'>
                      <div className='content-area'>
            ...
            <div id='block5' className='main-container__block'>
                 <div className='block-content'>
                      <div className='content-area'>
            ...
            <div id='block6' className='main-container__block'>
                 <div className='block-content'>
                      <div className='content-area'>
